...
<html lang="en">
    <head>
        ...
        <title>OnlineNotes Password reset</title>
...
<div class='form-group'>
    <label for='password'><strong><span id='content'>Enter your new password</span></strong></label>
    <input type='password' name='password' id='password' placeholder='Enter Password' class='form-control'>
    <label for='password'><strong><span id='content'>Re-enter password</span></strong></label>
    <input type='password' name='password2' id='password2' placeholder='Re-enter Password' class='form-control'>
</div>
<input type='submit' name='resetpassword' class='btn btn-success btn-lg' value='Reset Password' id='resetpassword'>
</form>
";
