...
$message .= "http://alanb.offyoucode.co.uk/OnlineNotes/resetpassword.php?user_id=" . urlencode($user_id) . "&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'OnlineNotes@onlineNotes.com')){
